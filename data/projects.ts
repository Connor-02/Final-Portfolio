export type Project = {
  ...
  title: string;
  summary: string;
  tags: readonly string[]; // <- key: wide, readonly string array
  links: {
    github?: string;
    live?: string;
  };
...
export const projects = [
  {
    ...
    summary:
      "Interactive phishing education with instant feedback and explainers.",
  ...
  },
  {
    ...
    summary:
      "Python + PySide6 budgeting app with recurring income, reminders, and a bunny mascot.",
